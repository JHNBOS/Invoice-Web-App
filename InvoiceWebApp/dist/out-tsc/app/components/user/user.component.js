...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.getAllUsers = function () {
        var _this = this;
        this.userService.getAll().subscribe(function (response) { return _this.users = response; }, function (error) { throw (error); });
    };
    UserComponent.prototype.deleteUser = function (email) {
        var _this = this;
        if (confirm('Are you sure you want to delete this user?')) {
            this.userService.delete(email).subscribe(function (response) { return _this.ngOnInit(); }, function (error) { throw (error); });
        }
    };
