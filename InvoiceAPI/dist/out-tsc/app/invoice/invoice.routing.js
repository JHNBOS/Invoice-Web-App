...
var routes = [
    {
        path: 'invoices',
        children: [
            { path: '', component: invoice_component_1.InvoiceComponent, canActivate: [authguard_service_1.AuthGuard], data: { title: 'Invoices' } },
            { path: 'create', component: create_invoice_component_1.CreateInvoiceComponent, canActivate: [authguard_service_1.AuthGuard], data: { title: 'Create Invoice' } }
        ]
    },
];
